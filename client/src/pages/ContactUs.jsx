...
function ContactUs() {
    ...
    return (
        <section className="bg-blue-400 py-10 mt-10">
                    ...
                    <form onSubmit={handleSubmit} className="bg-white p-6 rounded-lg shadow-lg w-full max-w-lg mx-auto">
                        <div className="mb-4">
                            ...
                            <input
                                ...
                                required
                                readOnly // Change to false if you want to allow edits
                        ...
                        <div>
                            <button type="submit" className="w-full py-3 bg-blue-500 text-white font-semibold rounded-lg hover:bg-blue-800 transition duration-300">
                                Submit
                            </button>
                        </div>
                    </form>
